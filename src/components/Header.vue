<template>
  <div>
    <v-app-bar app color="#02A28F" style="width: 1440px; height: 70px; flex-shrink: 0">
    ...
    <v-navigation-drawer app v-model="drawer" color="#02A28F" @click="drawer = false">
      <v-list>
        <v-list-item v-for="(item, index) in drawerItems" :key="index" @click="navigate(item.route)">
          <v-list-item-icon>
